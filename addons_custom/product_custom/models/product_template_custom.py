...
class ProductTemplate(models.Model):
    ...
    x_wage_per_unit = fields.Float(string='Wage per unit', tracking_visible="onchange")
    x_percentage_of_doctor_salary = fields.Float(string='Percentage of doctor\'s salary', tracking_visible="onchange")
