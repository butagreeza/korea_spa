...
class SurveyUserInputLine(models.Model):
    ...
    x_partner_interaction_id = fields.Many2one('partner.interaction', related='user_input_id.x_partner_interaction_id', string="Partner interaction", store=True, readonly=True)
    x_partner_interaction_date = fields.Date(related='user_input_id.x_partner_interaction_date', string="Partner interaction date", store=True, readonly=True)
    x_user_id = fields.Many2one(related='user_input_id.x_user_id', string="User", store=True, readonly=True)
    x_partner_id = fields.Many2one(related='user_input_id.partner_id', string="Partner", store=True, readonly=True)
