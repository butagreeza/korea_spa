...
class RptCongNoKH(models.TransientModel):
    ...
    def create_report(self):
        ...
        return {
            ...
            'url': url + "/report/frameset?__report=report_korea/" + report_name + param_str + param_str1,
            'target': 'new',
        }
        # return {
        ...
        #     'target': 'new',
        #     'context': {'birt_link': url + "/report/frameset?__report=report_korea/" + report_name + param_str}
        # }
    ...
    def create_report_excel(self):
        ...
        return {
            'type': 'ir.actions.act_url',
            'url': url + "/report/frameset?__report=report_korea/" + report_name + param_str + param_str1 + '&__format=xlsx',
            'target': 'self',
        }