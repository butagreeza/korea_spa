...
class ServiceCardUsingLine(models.Model):
    ...
    branch_id = fields.Many2one('res.branch', related="using_id.pos_session_id.branch_id", readonly=True, string="Branch", store=True)
    ...
    type = fields.Selection(
        [('service_card', 'service_card'), ('service_card1', 'service_card1')], string='Type')
