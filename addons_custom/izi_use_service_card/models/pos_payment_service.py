...
class PosPaymentService(models.Model):
    ...
    #     date_due = date.today() + timedelta(7)
    #     return date_due
    ...
    #09/07/2020 Thêm ngày đòi nợ khi thanh toán bằng hình thức ghi nợ
    ...
    def process_payment_service(self):
        ...
        # Nếu thanh toán bằng ghi nợ thì gắn ngày thanh toán công nợ vào đơn sddv
        if self.journal_id.code.upper() == 'GN':
            self.using_service_id.date_due = self.date_due
