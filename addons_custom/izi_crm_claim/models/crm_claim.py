...
class Claim(models.Model):
    ...
    name = fields.Char(related='partner_id.name', string="Subject", readonly=True)
    claim_date = fields.Datetime(string="Claim date", default=lambda self: fields.Datetime.now(), track_visibility='onchange')
    ...
    priority = fields.Selection([
        ('normal', 'Normal'),
        ('low', 'Low'),
        ('high', 'High')],default='normal', string="Priority")
